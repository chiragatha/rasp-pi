...
if __name__ == '__main__':
    ...
    try:
        main()
        kp = keypad()
        lcd_string("Enter Your Adhar No.",LCD_LINE_2,2)
        ...
        q(d9)
        print d9
        disp(d1+d2+d3+d4+d5+d6+d7+d8+d9)
        sleep(1)

        d10 = digit()
        q(d10)
        print d10
        disp(d1+d2+d3+d4+d5+d6+d7+d8+d9+d10)
        sleep(1)

        d11 = digit()
        q(d11)
        print d11
        disp(d1+d2+d3+d4+d5+d6+d7+d8+d9+d10+d11)
        sleep(1)

        d12 = digit()
        q(d12)
        print d12
        disp(d1+d2+d3+d4+d5+d6+d7+d8+d9+d10+d11+d12)
        ...
        lcd_byte(0x01, LCD_CMD)
        lcd_string("Aadhaar:%s " % (value),LCD_LINE_2,2)
      
        file=open("tosend.txt",'w')
        file.write("%s" %(value))
        file.close()
        client.txtfile(value)

        lcd_string("Choose Auth Mode",LCD_LINE_3,2)
        lcd_string("1-FingerPrint 2-OTP",LCD_LINE_4,2)
        
        def w(v):
          if v== '1':
            lcd_string("Scan Your Finger",LCD_LINE_3,2)
          ...
          if v=='2':
            lcd_string("Enter OTP",LCD_LINE_2,2)
            lcd_string("",LCD_LINE_3,2)
            lcd_string("",LCD_LINE_4,2)
            b1 = digit()
            q(b1)
            ...
            sleep(1)
            OTP= b1+b2+b3+b4
            lcd_string("OTP:%s"%(OTP),LCD_LINE_2,2)
            lcd_string("",LCD_LINE_3,2)
            lcd_string("",LCD_LINE_4,2)
            sleep(3)
